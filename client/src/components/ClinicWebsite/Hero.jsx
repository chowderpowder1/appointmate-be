...
const Hero = () => {
  return (
    ...
    <section className={HeroStyles.heroSection}>
            ...
            <div className={HeroStyles.heroGradient}></div>

            <div className={HeroStyles.heroText}>
                <h4>Welcome to Accelerated Wellness & Pain!</h4>
                <h1 >Your Path to Pain-Free Living Starts Here</h1>
                ...
                <Link to='/Appointment' className={HeroStyles.apptBtn} ><IoMdCalendar  className={HeroStyles.apptIcon} />Book an Appointment</Link>
            </div>
        </section>
