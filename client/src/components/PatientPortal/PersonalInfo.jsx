...
import {usePatientData, useUsers} from '../../queries/users'
const PersonalInfo = () => {
    ...
    if (patientDataIsLoading || userDataIsLoading) return <div>Loading...</div>;
    if (patientDataError || userDataError) return <div>Front End Error Return</div>;
  ...
  return (
    ...
    <div className={PersonalStyles.middleInitialContainer}>
        ...
        <p className={PersonalStyles.data}></p>
    </div>
    ...
    <div className={PersonalStyles.hmoContainer}>
        ...
        <p className={PersonalStyles.data}>{patientData.hmoCardPresented.toUpperCase()}</p>
    </div>

    <div className={PersonalStyles.hmoIdContainer}>
        <p className={PersonalStyles.dataTitle}>HMO ID Number</p>
        <p className={PersonalStyles.data}>{patientData.hmoNumber}</p>
    </div>
