...
import HistoryStyles from './PxMedicalHistory.module.css'

const PxMedicalHistory = () => {
  return (
<div className={HistoryStyles.historyContainer}>
        ...
        <div className={HistoryStyles.medicalHistoryDataContainer}>
          <div className={HistoryStyles.historyDataRow}>
            ...
            <p className={HistoryStyles.historyData}>CONTROLLED</p>  
            </div>
          ...
          <div className={HistoryStyles.historyDataRow}>
            ...
            <div className={HistoryStyles.historyDataItem}>
              <p className={HistoryStyles.historyDataTitle}>DOBUTAMINE STRESS ECHOCARDIOGRAM (DSE):</p>  
              <p className={HistoryStyles.historyData}>N/A</p>  
            </div>
...
export default PxMedicalHistory
